...
public void sendEmail(long pnrNo) throws AddressException {
	...
	final Email email = DefaultEmail.builder().from(new InternetAddress("priyankaborase2020@gmail.com"))
			.replyTo(new InternetAddress("priyankaborase2020@gmail.com"))
			.to(Lists.newArrayList(new InternetAddress("priyankaborase2020@gmail.com")))
